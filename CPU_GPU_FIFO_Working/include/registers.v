...
`define NETWORK_PROCESSOR_BLOCK_ADDR_WIDTH  18
`define NETWORK_PROCESSOR_REG_ADDR_WIDTH    5
...
`define NETWORK_PROCESSOR_BLOCK_ADDR  18'h00006
...
`define NETWORK_PROCESSOR_GPU_IMEM_INTERACT     5'h0
`define NETWORK_PROCESSOR_GPU_IMEM_WRITE        5'h1
`define NETWORK_PROCESSOR_GPU_IMEM_RW_ADDRESS   5'h2
`define NETWORK_PROCESSOR_GPU_IMEM_WDATA        5'h3
`define NETWORK_PROCESSOR_CPU_IMEM_INTERACT     5'h4
`define NETWORK_PROCESSOR_CPU_IMEM_WRITE        5'h5
`define NETWORK_PROCESSOR_CPU_IMEM_RW_ADDRESS   5'h6
`define NETWORK_PROCESSOR_CPU_IMEM_WDATA        5'h7
`define NETWORK_PROCESSOR_SW_RESET              5'h8
`define NETWORK_PROCESSOR_FIFO_DMEM_R_ADDR      5'h9
`define NETWORK_PROCESSOR_FIFO_DMEM_INTERACT    5'ha
`define NETWORK_PROCESSOR_GPU_IMEM_RDATA        5'hb
`define NETWORK_PROCESSOR_GPU_PC_END            5'hc
`define NETWORK_PROCESSOR_CPU_IMEM_RDATA        5'hd
`define NETWORK_PROCESSOR_CPU_PC_END            5'he
`define NETWORK_PROCESSOR_FIFO_DMEM_RDATA_LOW   5'hf
`define NETWORK_PROCESSOR_FIFO_STATE            5'h10
`define NETWORK_PROCESSOR_FIFO_DMEM_RDATA_MID   5'h11
`define NETWORK_PROCESSOR_FIFO_DMEM_RDATA_HIGH  5'h12
