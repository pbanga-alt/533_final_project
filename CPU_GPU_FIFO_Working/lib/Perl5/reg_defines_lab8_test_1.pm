...
#
# Project: Reference NIC (lab8_test_1)
# Description: Reference NIC
#
#############################################################

package reg_defines_lab8_test_1;
...
@EXPORT = qw(
                ...
                NETWORK_PROCESSOR_GLOBAL_RESET_REG
...
sub DEVICE_PROJ_DIR ()  { "lab8_test_1"; }
...
sub NETWORK_PROCESSOR_BASE_ADDR ()   { 0x2001100; }
...
# File: projects/lab8_test_1/include/network_processor.xml
sub NETWORK_PROCESSOR_GPU_IMEM_RDATA_REG ()        { 0x2001100;}
sub NETWORK_PROCESSOR_GPU_PC_END_REG ()            { 0x2001104;}
sub NETWORK_PROCESSOR_CPU_IMEM_RDATA_REG ()        { 0x2001108;}
sub NETWORK_PROCESSOR_CPU_PC_END_REG ()            { 0x200110c;}
sub NETWORK_PROCESSOR_GPU_IMEM_INTERACT_REG ()     { 0x2001110;}
sub NETWORK_PROCESSOR_GPU_IMEM_WRITE_REG ()        { 0x2001114;}
sub NETWORK_PROCESSOR_GPU_IMEM_RW_ADDRESS_REG ()   { 0x2001118;}
sub NETWORK_PROCESSOR_GPU_IMEM_WDATA_REG ()        { 0x200111c;}
sub NETWORK_PROCESSOR_CPU_IMEM_INTERACT_REG ()     { 0x2001120;}
sub NETWORK_PROCESSOR_CPU_IMEM_WRITE_REG ()        { 0x2001124;}
sub NETWORK_PROCESSOR_CPU_IMEM_RW_ADDRESS_REG ()   { 0x2001128;}
sub NETWORK_PROCESSOR_CPU_IMEM_WDATA_REG ()        { 0x200112c;}
sub NETWORK_PROCESSOR_GLOBAL_RESET_REG ()          { 0x2001130;}
