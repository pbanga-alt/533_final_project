...
#
# Project: Reference NIC (lab6_test_2)
# Description: Reference NIC
#
#############################################################

package reg_defines_lab6_test_2;
...
@EXPORT = qw(
                ...
                PIPELINE_DATAPATH_DMEM_WDATA_HI_REG
                PIPELINE_DATAPATH_DMEM_WDATA_LO_REG
                PIPELINE_DATAPATH_IMEM_RDATA_REG
                PIPELINE_DATAPATH_DMEM_RDATA_LO_REG
                PIPELINE_DATAPATH_DMEM_RDATA_HI_REG
...
sub DEVICE_PROJ_DIR ()  { "lab6_test_2"; }
...
sub PIPELINE_DATAPATH_BASE_ADDR ()   { 0x2001100; }
...
# File: projects/lab6_test_2/include/pipeline_datapath.xml
sub PIPELINE_DATAPATH_IMEM_INTERACT_REG ()     { 0x2001100;}
sub PIPELINE_DATAPATH_IMEM_WRITE_REG ()        { 0x2001104;}
sub PIPELINE_DATAPATH_IMEM_RW_ADDRESS_REG ()   { 0x2001108;}
sub PIPELINE_DATAPATH_IMEM_WDATA_REG ()        { 0x200110c;}
sub PIPELINE_DATAPATH_DMEM_INTERACT_REG ()     { 0x2001110;}
sub PIPELINE_DATAPATH_DMEM_WRITE_REG ()        { 0x2001114;}
sub PIPELINE_DATAPATH_DMEM_RW_ADDRESS_REG ()   { 0x2001118;}
sub PIPELINE_DATAPATH_DMEM_WDATA_HI_REG ()     { 0x200111c;}
sub PIPELINE_DATAPATH_DMEM_WDATA_LO_REG ()     { 0x2001120;}
sub PIPELINE_DATAPATH_IMEM_RDATA_REG ()        { 0x2001124;}
sub PIPELINE_DATAPATH_DMEM_RDATA_LO_REG ()     { 0x2001128;}
sub PIPELINE_DATAPATH_DMEM_RDATA_HI_REG ()     { 0x200112c;}
sub PIPELINE_DATAPATH_HWREG1_REG ()            { 0x2001130;}
