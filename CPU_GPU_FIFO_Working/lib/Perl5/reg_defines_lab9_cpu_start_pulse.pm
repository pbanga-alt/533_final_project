...
#
# Project: Reference NIC (lab9_cpu_start_pulse)
# Description: Reference NIC
#
#############################################################

package reg_defines_lab9_cpu_start_pulse;
...
@EXPORT = qw(
                ...
                IN_ARB_STATE_REG
                NETWORK_PROCESSOR_GPU_IMEM_INTERACT_REG
                NETWORK_PROCESSOR_GPU_IMEM_WRITE_REG
                NETWORK_PROCESSOR_GPU_IMEM_RW_ADDRESS_REG
                NETWORK_PROCESSOR_GPU_IMEM_WDATA_REG
                NETWORK_PROCESSOR_CPU_IMEM_INTERACT_REG
                NETWORK_PROCESSOR_CPU_IMEM_WRITE_REG
                NETWORK_PROCESSOR_CPU_IMEM_RW_ADDRESS_REG
                NETWORK_PROCESSOR_CPU_IMEM_WDATA_REG
                NETWORK_PROCESSOR_SW_RESET_REG
                NETWORK_PROCESSOR_FIFO_DMEM_R_ADDR_REG
                NETWORK_PROCESSOR_FIFO_DMEM_INTERACT_REG
                NETWORK_PROCESSOR_GPU_IMEM_RDATA_REG
                NETWORK_PROCESSOR_GPU_PC_END_REG
                NETWORK_PROCESSOR_CPU_IMEM_RDATA_REG
                NETWORK_PROCESSOR_CPU_PC_END_REG
                NETWORK_PROCESSOR_FIFO_DMEM_RDATA_LOW_REG
                NETWORK_PROCESSOR_FIFO_STATE_REG
                NETWORK_PROCESSOR_FIFO_DMEM_RDATA_MID_REG
                NETWORK_PROCESSOR_FIFO_DMEM_RDATA_HIGH_REG
                OQ_QUEUE_0_CTRL_REG
...
sub DEVICE_PROJ_DIR ()  { "lab9_cpu_start_pulse"; }
...
sub NETWORK_PROCESSOR_BASE_ADDR ()   { 0x2000300; }
...
# Name: network_processor (NETWORK_PROCESSOR)
# Description: Registers for Pipeline CPU with Trace Buffer
# File: projects/lab9_cpu_start_pulse/include/network_processor.xml
sub NETWORK_PROCESSOR_GPU_IMEM_INTERACT_REG ()      { 0x2000300;}
sub NETWORK_PROCESSOR_GPU_IMEM_WRITE_REG ()         { 0x2000304;}
sub NETWORK_PROCESSOR_GPU_IMEM_RW_ADDRESS_REG ()    { 0x2000308;}
sub NETWORK_PROCESSOR_GPU_IMEM_WDATA_REG ()         { 0x200030c;}
sub NETWORK_PROCESSOR_CPU_IMEM_INTERACT_REG ()      { 0x2000310;}
sub NETWORK_PROCESSOR_CPU_IMEM_WRITE_REG ()         { 0x2000314;}
sub NETWORK_PROCESSOR_CPU_IMEM_RW_ADDRESS_REG ()    { 0x2000318;}
sub NETWORK_PROCESSOR_CPU_IMEM_WDATA_REG ()         { 0x200031c;}
sub NETWORK_PROCESSOR_SW_RESET_REG ()               { 0x2000320;}
sub NETWORK_PROCESSOR_FIFO_DMEM_R_ADDR_REG ()       { 0x2000324;}
sub NETWORK_PROCESSOR_FIFO_DMEM_INTERACT_REG ()     { 0x2000328;}
sub NETWORK_PROCESSOR_GPU_IMEM_RDATA_REG ()         { 0x200032c;}
sub NETWORK_PROCESSOR_GPU_PC_END_REG ()             { 0x2000330;}
sub NETWORK_PROCESSOR_CPU_IMEM_RDATA_REG ()         { 0x2000334;}
sub NETWORK_PROCESSOR_CPU_PC_END_REG ()             { 0x2000338;}
sub NETWORK_PROCESSOR_FIFO_DMEM_RDATA_LOW_REG ()    { 0x200033c;}
sub NETWORK_PROCESSOR_FIFO_STATE_REG ()             { 0x2000340;}
sub NETWORK_PROCESSOR_FIFO_DMEM_RDATA_MID_REG ()    { 0x2000344;}
sub NETWORK_PROCESSOR_FIFO_DMEM_RDATA_HIGH_REG ()   { 0x2000348;}
