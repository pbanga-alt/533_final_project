...
#
# Project: Reference NIC (lab5_test)
# Description: Reference NIC
#
#############################################################

package reg_defines_lab5_test;
...
@EXPORT = qw(
                ...
                IN_ARB_STATE_REG
                PIPELINE_DATAPATH_SW_CONTROL_REG_REG
                PIPELINE_DATAPATH_SW_TRACE_RD_ADDR_REG
                PIPELINE_DATAPATH_TRACE_STATUS_REG
                PIPELINE_DATAPATH_TRACE_PC_INFO_REG
                PIPELINE_DATAPATH_TRACE_INSTR_REG
                PIPELINE_DATAPATH_TRACE_WB_LO_REG
                PIPELINE_DATAPATH_TRACE_WB_HI_REG
...
# File: projects/lab5_test/include/pipeline_datapath.xml
sub PIPELINE_DATAPATH_SW_CONTROL_REG_REG ()     { 0x2001100;}
sub PIPELINE_DATAPATH_SW_TRACE_RD_ADDR_REG ()   { 0x2001104;}
sub PIPELINE_DATAPATH_TRACE_STATUS_REG ()       { 0x2001108;}
sub PIPELINE_DATAPATH_TRACE_PC_INFO_REG ()      { 0x200110c;}
sub PIPELINE_DATAPATH_TRACE_INSTR_REG ()        { 0x2001110;}
sub PIPELINE_DATAPATH_TRACE_WB_LO_REG ()        { 0x2001114;}
sub PIPELINE_DATAPATH_TRACE_WB_HI_REG ()        { 0x2001118;}
