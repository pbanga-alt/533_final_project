...
def NETWORK_PROCESSOR_BASE_ADDR (): 
    return 0x2000300
...
def NETWORK_PROCESSOR_GPU_IMEM_INTERACT_REG ():    
    return 0x2000300

def NETWORK_PROCESSOR_GPU_IMEM_WRITE_REG ():       
    return 0x2000304

def NETWORK_PROCESSOR_GPU_IMEM_RW_ADDRESS_REG ():  
    return 0x2000308

def NETWORK_PROCESSOR_GPU_IMEM_WDATA_REG ():       
    return 0x200030c

def NETWORK_PROCESSOR_CPU_IMEM_INTERACT_REG ():    
    return 0x2000310

def NETWORK_PROCESSOR_CPU_IMEM_WRITE_REG ():       
    return 0x2000314

def NETWORK_PROCESSOR_CPU_IMEM_RW_ADDRESS_REG ():  
    return 0x2000318

def NETWORK_PROCESSOR_CPU_IMEM_WDATA_REG ():       
    return 0x200031c

def NETWORK_PROCESSOR_SW_RESET_REG ():             
    return 0x2000320

def NETWORK_PROCESSOR_FIFO_DMEM_R_ADDR_REG ():     
    return 0x2000324

def NETWORK_PROCESSOR_FIFO_DMEM_INTERACT_REG ():   
    return 0x2000328

def NETWORK_PROCESSOR_GPU_IMEM_RDATA_REG ():       
    return 0x200032c

def NETWORK_PROCESSOR_GPU_PC_END_REG ():           
    return 0x2000330

def NETWORK_PROCESSOR_CPU_IMEM_RDATA_REG ():       
    return 0x2000334

def NETWORK_PROCESSOR_CPU_PC_END_REG ():           
    return 0x2000338

def NETWORK_PROCESSOR_FIFO_DMEM_RDATA_LOW_REG ():  
    return 0x200033c

def NETWORK_PROCESSOR_FIFO_STATE_REG ():           
    return 0x2000340

def NETWORK_PROCESSOR_FIFO_DMEM_RDATA_MID_REG ():  
    return 0x2000344

def NETWORK_PROCESSOR_FIFO_DMEM_RDATA_HIGH_REG (): 
    return 0x2000348
...
__main__.nf_regmap.update({
    ...
    0x2000300 : "NETWORK_PROCESSOR_GPU_IMEM_INTERACT_REG",
    0x2000304 : "NETWORK_PROCESSOR_GPU_IMEM_WRITE_REG",
    0x2000308 : "NETWORK_PROCESSOR_GPU_IMEM_RW_ADDRESS_REG",
    0x200030c : "NETWORK_PROCESSOR_GPU_IMEM_WDATA_REG",
    0x2000310 : "NETWORK_PROCESSOR_CPU_IMEM_INTERACT_REG",
    0x2000314 : "NETWORK_PROCESSOR_CPU_IMEM_WRITE_REG",
    0x2000318 : "NETWORK_PROCESSOR_CPU_IMEM_RW_ADDRESS_REG",
    0x200031c : "NETWORK_PROCESSOR_CPU_IMEM_WDATA_REG",
    0x2000320 : "NETWORK_PROCESSOR_SW_RESET_REG",
    0x2000324 : "NETWORK_PROCESSOR_FIFO_DMEM_R_ADDR_REG",
    0x2000328 : "NETWORK_PROCESSOR_FIFO_DMEM_INTERACT_REG",
    0x200032c : "NETWORK_PROCESSOR_GPU_IMEM_RDATA_REG",
    0x2000330 : "NETWORK_PROCESSOR_GPU_PC_END_REG",
    0x2000334 : "NETWORK_PROCESSOR_CPU_IMEM_RDATA_REG",
    0x2000338 : "NETWORK_PROCESSOR_CPU_PC_END_REG",
    0x200033c : "NETWORK_PROCESSOR_FIFO_DMEM_RDATA_LOW_REG",
    0x2000340 : "NETWORK_PROCESSOR_FIFO_STATE_REG",
    0x2000344 : "NETWORK_PROCESSOR_FIFO_DMEM_RDATA_MID_REG",
    0x2000348 : "NETWORK_PROCESSOR_FIFO_DMEM_RDATA_HIGH_REG",
