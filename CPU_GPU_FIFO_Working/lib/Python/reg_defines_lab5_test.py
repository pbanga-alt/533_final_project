...
def PIPELINE_DATAPATH_SW_CONTROL_REG_REG ():   
    return 0x2001100

def PIPELINE_DATAPATH_SW_TRACE_RD_ADDR_REG (): 
    return 0x2001104

def PIPELINE_DATAPATH_TRACE_STATUS_REG ():     
    return 0x2001108

def PIPELINE_DATAPATH_TRACE_PC_INFO_REG ():    
    return 0x200110c

def PIPELINE_DATAPATH_TRACE_INSTR_REG ():      
    return 0x2001110

def PIPELINE_DATAPATH_TRACE_WB_LO_REG ():      
    return 0x2001114

def PIPELINE_DATAPATH_TRACE_WB_HI_REG ():      
    return 0x2001118
...
__main__.nf_regmap.update({
    ...
    0x2001100 : "PIPELINE_DATAPATH_SW_CONTROL_REG_REG",
    0x2001104 : "PIPELINE_DATAPATH_SW_TRACE_RD_ADDR_REG",
    0x2001108 : "PIPELINE_DATAPATH_TRACE_STATUS_REG",
    0x200110c : "PIPELINE_DATAPATH_TRACE_PC_INFO_REG",
    0x2001110 : "PIPELINE_DATAPATH_TRACE_INSTR_REG",
    0x2001114 : "PIPELINE_DATAPATH_TRACE_WB_LO_REG",
    0x2001118 : "PIPELINE_DATAPATH_TRACE_WB_HI_REG",
