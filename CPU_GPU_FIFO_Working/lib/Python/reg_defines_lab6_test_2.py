...
def PIPELINE_DATAPATH_DMEM_WDATA_HI_REG ():   
    return 0x200111c

def PIPELINE_DATAPATH_DMEM_WDATA_LO_REG ():   
    return 0x2001120

def PIPELINE_DATAPATH_IMEM_RDATA_REG ():      
    return 0x2001124

def PIPELINE_DATAPATH_DMEM_RDATA_LO_REG ():   
    return 0x2001128

def PIPELINE_DATAPATH_DMEM_RDATA_HI_REG ():   
    return 0x200112c
...
__main__.nf_regmap.update({
    ...
    0x2001100 : "PIPELINE_DATAPATH_IMEM_INTERACT_REG",
    0x2001104 : "PIPELINE_DATAPATH_IMEM_WRITE_REG",
    0x2001108 : "PIPELINE_DATAPATH_IMEM_RW_ADDRESS_REG",
    0x200110c : "PIPELINE_DATAPATH_IMEM_WDATA_REG",
    0x2001110 : "PIPELINE_DATAPATH_DMEM_INTERACT_REG",
    0x2001114 : "PIPELINE_DATAPATH_DMEM_WRITE_REG",
    0x2001118 : "PIPELINE_DATAPATH_DMEM_RW_ADDRESS_REG",
    0x200111c : "PIPELINE_DATAPATH_DMEM_WDATA_HI_REG",
    0x2001120 : "PIPELINE_DATAPATH_DMEM_WDATA_LO_REG",
    0x2001124 : "PIPELINE_DATAPATH_IMEM_RDATA_REG",
    0x2001128 : "PIPELINE_DATAPATH_DMEM_RDATA_LO_REG",
    0x200112c : "PIPELINE_DATAPATH_DMEM_RDATA_HI_REG",
    0x2001130 : "PIPELINE_DATAPATH_HWREG1_REG",
