...
#
# Project: Lab8 (lab8)
# Description: Network FIFO
#
#############################################################

package reg_defines_lab8;
...
@EXPORT = qw(
                ...
                IN_ARB_STATE_REG
                NETWORK_MEM_COMMAND_REG_REG
                NETWORK_MEM_MEM_ADDR_REG
                NETWORK_MEM_MEM_DATA_LSB_REG
                NETWORK_MEM_MEM_DATA_MSB_REG
                NETWORK_MEM_MEM_CTRL_REG
                NETWORK_MEM_PKT_START_DEBUG_REG
                NETWORK_MEM_PKT_END_DEBUG_REG
                NETWORK_MEM_FLAG_REG
                NETWORK_MEM_FIRST_DATA_DEBUG_REG
                NETWORK_MEM_HEAD_PTR_DEBUG_REG
                NETWORK_MEM_TAIL_PTR_DEBUG_REG
                NETWORK_MEM_PAYLOAD_CYCLES_DEBUG_REG
                NETWORK_MEM_CURR_STATE_DEBUG_REG
                NETWORK_MEM_OUT_WR_CT_DEBUG_REG
                OQ_QUEUE_0_CTRL_REG
...
sub DEVICE_PROJ_DIR ()  { "lab8"; }
sub DEVICE_PROJ_NAME () { "Lab8"; }
sub DEVICE_PROJ_DESC () { "Network FIFO"; }
...
sub NETWORK_MEM_BASE_ADDR ()     { 0x2000200; }
...
# Name: network_mem (NETWORK_MEM)
# Description: Registers for Network Memory FIFO
# File: projects/lab8/include/network_mem.xml
sub NETWORK_MEM_COMMAND_REG_REG ()            { 0x2000200;}
sub NETWORK_MEM_MEM_ADDR_REG ()               { 0x2000204;}
sub NETWORK_MEM_MEM_DATA_LSB_REG ()           { 0x2000208;}
sub NETWORK_MEM_MEM_DATA_MSB_REG ()           { 0x200020c;}
sub NETWORK_MEM_MEM_CTRL_REG ()               { 0x2000210;}
sub NETWORK_MEM_PKT_START_DEBUG_REG ()        { 0x2000214;}
sub NETWORK_MEM_PKT_END_DEBUG_REG ()          { 0x2000218;}
sub NETWORK_MEM_FLAG_REG ()                   { 0x200021c;}
sub NETWORK_MEM_FIRST_DATA_DEBUG_REG ()       { 0x2000220;}
sub NETWORK_MEM_HEAD_PTR_DEBUG_REG ()         { 0x2000224;}
sub NETWORK_MEM_TAIL_PTR_DEBUG_REG ()         { 0x2000228;}
sub NETWORK_MEM_PAYLOAD_CYCLES_DEBUG_REG ()   { 0x200022c;}
sub NETWORK_MEM_CURR_STATE_DEBUG_REG ()       { 0x2000230;}
sub NETWORK_MEM_OUT_WR_CT_DEBUG_REG ()        { 0x2000234;}
