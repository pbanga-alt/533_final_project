...
def NETWORK_MEM_COMMAND_REG_REG ():          
    return 0x2000200

def NETWORK_MEM_MEM_ADDR_REG ():             
    return 0x2000204

def NETWORK_MEM_MEM_DATA_LSB_REG ():         
    return 0x2000208

def NETWORK_MEM_MEM_DATA_MSB_REG ():         
    return 0x200020c

def NETWORK_MEM_MEM_CTRL_REG ():             
    return 0x2000210

def NETWORK_MEM_PKT_START_DEBUG_REG ():      
    return 0x2000214

def NETWORK_MEM_PKT_END_DEBUG_REG ():        
    return 0x2000218

def NETWORK_MEM_FLAG_REG ():                 
    return 0x200021c

def NETWORK_MEM_FIRST_DATA_DEBUG_REG ():     
    return 0x2000220

def NETWORK_MEM_HEAD_PTR_DEBUG_REG ():       
    return 0x2000224

def NETWORK_MEM_TAIL_PTR_DEBUG_REG ():       
    return 0x2000228

def NETWORK_MEM_PAYLOAD_CYCLES_DEBUG_REG (): 
    return 0x200022c

def NETWORK_MEM_CURR_STATE_DEBUG_REG ():     
    return 0x2000230

def NETWORK_MEM_OUT_WR_CT_DEBUG_REG ():      
    return 0x2000234
...
__main__.nf_regmap.update({
    ...
    0x2000200 : "NETWORK_MEM_COMMAND_REG_REG",
    0x2000204 : "NETWORK_MEM_MEM_ADDR_REG",
    0x2000208 : "NETWORK_MEM_MEM_DATA_LSB_REG",
    0x200020c : "NETWORK_MEM_MEM_DATA_MSB_REG",
    0x2000210 : "NETWORK_MEM_MEM_CTRL_REG",
    0x2000214 : "NETWORK_MEM_PKT_START_DEBUG_REG",
    0x2000218 : "NETWORK_MEM_PKT_END_DEBUG_REG",
    0x200021c : "NETWORK_MEM_FLAG_REG",
    0x2000220 : "NETWORK_MEM_FIRST_DATA_DEBUG_REG",
    0x2000224 : "NETWORK_MEM_HEAD_PTR_DEBUG_REG",
    0x2000228 : "NETWORK_MEM_TAIL_PTR_DEBUG_REG",
    0x200022c : "NETWORK_MEM_PAYLOAD_CYCLES_DEBUG_REG",
    0x2000230 : "NETWORK_MEM_CURR_STATE_DEBUG_REG",
    0x2000234 : "NETWORK_MEM_OUT_WR_CT_DEBUG_REG",
